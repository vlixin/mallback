...
```
    ...
    <logger name="com.lixin.litemall.core" level="DEBUG" />
    <logger name="com.lixin.litemall.db" level="DEBUG" />
    <logger name="com.lixin.litemall.admin" level="DEBUG" />
    <logger name="com.lixin.litemall.wx" level="DEBUG" />
    <logger name="com.lixin.litemall" level="DEBUG" />
```

具体如何配置，请自行学习Spring Boot的日志配置和logback日志配置。

`com.lixin.litemall.core`定义litemall-core模块的日志级别
`com.lixin.litemall.db`定义litemall-db模块的日志级别
`com.lixin.litemall.wx`定义litemall-wx-api模块的日志级别
`com.lixin.litemall.admin`定义litemall-admin-api模块的日志级别
`com.lixin.litemall`而定义litemall所有后端模块的日志级别
