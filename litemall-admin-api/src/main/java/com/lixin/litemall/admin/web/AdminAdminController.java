...
import com.lixin.litemall.core.util.RegexUtil;
...
import static com.lixin.litemall.admin.util.AdminResponseCode.*;
...
public class AdminAdminController {
    ...
    //("admin:admin:list")
    //Desc(menu = {"系统管理", "管理员管理"}, button = "查询")
    @GetMapping("/list")
    ...
    //("admin:admin:create")
    //Desc(menu = {"系统管理", "管理员管理"}, button = "添加")
    @PostMapping("/create")
    ...
    //("admin:admin:read")
    //Desc(menu = {"系统管理", "管理员管理"}, button = "详情")
    @GetMapping("/read")
    ...
    //("admin:admin:update")
    //Desc(menu = {"系统管理", "管理员管理"}, button = "编辑")
    @PostMapping("/update")
    ...
    //("admin:admin:delete")
    //Desc(menu = {"系统管理", "管理员管理"}, button = "删除")
    @PostMapping("/delete")
