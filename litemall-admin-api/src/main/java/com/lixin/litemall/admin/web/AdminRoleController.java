...
import com.lixin.litemall.admin.vo.PermVo;
...
import static com.lixin.litemall.admin.util.AdminResponseCode.ROLE_NAME_EXIST;
import static com.lixin.litemall.admin.util.AdminResponseCode.ROLE_USER_EXIST;
...
public class AdminRoleController {
    ...
    //("admin:role:list")
    //Desc(menu = {"系统管理", "角色管理"}, button = "角色查询")
    @GetMapping("/list")
    ...
    //("admin:role:read")
    //Desc(menu = {"系统管理", "角色管理"}, button = "角色详情")
    @GetMapping("/read")
    ...
    //("admin:role:create")
    //Desc(menu = {"系统管理", "角色管理"}, button = "角色添加")
    @PostMapping("/create")
    ...
    //("admin:role:update")
    //Desc(menu = {"系统管理", "角色管理"}, button = "角色编辑")
    @PostMapping("/update")
    ...
    //("admin:role:delete")
    //Desc(menu = {"系统管理", "角色管理"}, button = "角色删除")
    @PostMapping("/delete")
 ...
 *//*
    ...
    //Desc(menu = {"系统管理", "角色管理"}, button = "权限详情")
 ...
 *//*
    ...
    //Desc(menu = {"系统管理", "角色管理"}, button = "权限变更")
