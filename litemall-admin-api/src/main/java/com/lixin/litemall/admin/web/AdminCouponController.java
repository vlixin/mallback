...
import com.lixin.litemall.db.service.LitemallCouponService;
import com.lixin.litemall.db.service.LitemallCouponUserService;
import com.lixin.litemall.db.util.CouponConstant;
...
public class AdminCouponController {
    ...
    //("admin:coupon:list")
    //Desc(menu = {"推广管理", "优惠券管理"}, button = "查询")
    @GetMapping("/list")
    ...
    //Desc(menu = {"推广管理", "优惠券管理"}, button = "查询用户")
    @GetMapping("/listuser")
    ...
    //("admin:coupon:create")
    //Desc(menu = {"推广管理", "优惠券管理"}, button = "添加")
    @PostMapping("/create")
    ...
    //("admin:coupon:read")
    //Desc(menu = {"推广管理", "优惠券管理"}, button = "详情")
    @GetMapping("/read")
    ...
    //("admin:coupon:update")
    //Desc(menu = {"推广管理", "优惠券管理"}, button = "编辑")
    @PostMapping("/update")
    ...
    //("admin:coupon:delete")
    //Desc(menu = {"推广管理", "优惠券管理"}, button = "删除")
    @PostMapping("/delete")
