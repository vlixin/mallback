package com.lixin.litemall.allinone;
...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.com.lixin.litemall.wx"));
        System.out.println(environment.getProperty("logging.level.com.lixin.litemall.admin"));
        System.out.println(environment.getProperty("logging.level.com.lixin.litemall"));
    }
