...
public class LitemallTopicExample {
    ...
    public interface IExampleWhen {
        void example(com.lixin.litemall.db.domain.LitemallTopicExample example);
    }
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addGoodsCriterion(String condition, Object value, String property) {
            ...
            goodsCriteria.add(new Criterion(condition, value, "com.lixin.litemall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addGoodsCriterion(String condition, Integer[] value1, Integer[] value2, String property) {
            ...
            goodsCriteria.add(new Criterion(condition, value1, value2, "com.lixin.litemall.db.mybatis.JsonIntegerArrayTypeHandler"));
            allCriteria = null;
        }
