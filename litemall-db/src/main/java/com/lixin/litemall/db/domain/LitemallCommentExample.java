...
public class LitemallCommentExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addPicUrlsCriterion(String condition, Object value, String property) {
            ...
            picUrlsCriteria.add(new Criterion(condition, value, "com.lixin.litemall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addPicUrlsCriterion(String condition, String[] value1, String[] value2, String property) {
            ...
            picUrlsCriteria.add(new Criterion(condition, value1, value2, "com.lixin.litemall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
