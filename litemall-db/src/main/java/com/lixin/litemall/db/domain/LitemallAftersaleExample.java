...
public class LitemallAftersaleExample {
    ...
    public interface IExampleWhen {
        void example(com.lixin.litemall.db.domain.LitemallAftersaleExample example);
    }
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addPicturesCriterion(String condition, Object value, String property) {
            ...
            picturesCriteria.add(new Criterion(condition, value, "com.lixin.litemall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addPicturesCriterion(String condition, String[] value1, String[] value2, String property) {
            ...
            picturesCriteria.add(new Criterion(condition, value1, value2, "com.lixin.litemall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
