...
public class LitemallGoodsExample {
    ...
    public interface IExampleWhen {
        void example(com.lixin.litemall.db.domain.LitemallGoodsExample example);
    }
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addGalleryCriterion(String condition, Object value, String property) {
            ...
            galleryCriteria.add(new Criterion(condition, value, "com.lixin.litemall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
        ...
        protected void addGalleryCriterion(String condition, String[] value1, String[] value2, String property) {
            ...
            galleryCriteria.add(new Criterion(condition, value1, value2, "com.lixin.litemall.db.mybatis.JsonStringArrayTypeHandler"));
            allCriteria = null;
        }
