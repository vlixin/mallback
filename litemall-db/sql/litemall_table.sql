...
(
    ...
    `shop_id`      varchar(255) NOT NULL DEFAULT '' COMMENT '店铺商ID',
    `shop_pic_url` varchar(255) NOT NULL DEFAULT '' COMMENT '店铺商图片',
    `add_time`     datetime              DEFAULT NULL COMMENT '创建时间',
    `update_time`  datetime              DEFAULT NULL COMMENT '更新时间',
    `deleted`      tinyint(1)            DEFAULT '0' COMMENT '逻辑删除',
    PRIMARY KEY (`id`)
...
(
    ...
    `update_time`   datetime              DEFAULT NULL COMMENT '更新时间',
    `deleted`       tinyint(1)            DEFAULT '0' COMMENT '逻辑删除',
    `shop_id`       varchar(31)           DEFAULT '000' COMMENT '店铺ID',
    PRIMARY KEY (`id`),
